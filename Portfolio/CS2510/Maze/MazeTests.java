...
class ExamplesMazeWorld100x40 {
  void testMakeScene(Tester t) {
    MazeWorld world = new MazeWorld(100, 40);
    world.bigBang(1000, 1000, 0.1);
  }
}

class ExamplesMazeWorld100x100 {
  void testMakeScene(Tester t) {
    MazeWorld world = new MazeWorld(100, 100);
    world.bigBang(1000, 1000, 0.1);
  }
}
...
class ExamplesMazeCellandEdgeandGraphandWorldMethods {
  ...
  void testAllToCells(Tester t) {
    ...
    expectedListForx0y0.add(this.cellx0y1);
    expectedListForx0y0.add(this.cellx1y0);
    // t.checkExpect(cellx0y0.allToCells(), expectedListForx0y0);

    ArrayList<MazeCell> expectedListForx2y2 = new ArrayList<>();
    expectedListForx2y2.add(this.cellx2y1);
    expectedListForx2y2.add(this.cellx1y2);
    expectedListForx2y2.add(this.cellx3y2);
    expectedListForx2y2.add(this.cellx2y3);
    // t.checkExpect(cellx2y2.allToCells(), expectedListForx2y2);

    ArrayList<MazeCell> expectedListForx4y4 = new ArrayList<>();
    expectedListForx4y4.add(this.cellx4y3);
    expectedListForx4y4.add(this.cellx3y4);
  ...
  void testEquals(Tester t) {
    ...
    t.checkExpect(this.cellx1y1.equals(this.cellx1y1), true);
    t.checkExpect(this.cellx1y1.equals(cellx1y1a), true);
    t.checkExpect(this.cellx1y1.equals(this.cellx1y2), false);
    t.checkExpect(this.cellx1y1.equals(this.cellx3y2), false);
  }

  void testHashCode(Tester t) {
    this.setEdges();
    MazeCell cellx1y1a = new MazeCell(1, 1);
    t.checkExpect(this.cellx1y1.hashCode(), 1001);
    t.checkExpect(cellx1y1a.hashCode(), 1001);
    t.checkExpect(this.cellx1y2.hashCode(), 1002);
    t.checkExpect(this.cellx3y2.hashCode(), 3002);
  }

  void testGetFrom(Tester t) {
    this.setEdges();
    Edge x0y0edgex0y1 = new Edge(this.cellx0y0, this.cellx0y1, new Random(1));
    t.checkExpect(x0y0edgex0y1.getFrom(), this.cellx0y0);
  }

  void testGetTo(Tester t) {
    this.setEdges();
    Edge x0y0edgex0y1 = new Edge(this.cellx0y0, this.cellx0y1, new Random(1));
    t.checkExpect(x0y0edgex0y1.getTo(), this.cellx0y1);
  }

  void testAddTheFrom(Tester t) {
    this.setEdges();

    Edge x0y0edge01y1 = new Edge(this.cellx0y0, this.cellx0y1, new Random(1));
    ...
    allTosResult.add(this.cellx0y1);
  ...
  void testSameRepresentative(Tester t) {
    ...
    representatives.put(this.cellx0y0, this.cellx0y1);
    representatives.put(this.cellx0y1, this.cellx0y1);
  ...
  void testUnionize(Tester t) {
    ...
    representativesResult.put(this.cellx0y0, this.cellx0y0);
    representativesResult.put(this.cellx0y1, this.cellx0y1);

    x0y0edge01y1.unionize(representativesResult);
    t.checkExpect(representativesResult.get(this.cellx0y0), this.cellx0y1);
    t.checkExpect(representativesResult.get(this.cellx0y1), this.cellx0y1);
  }
}
