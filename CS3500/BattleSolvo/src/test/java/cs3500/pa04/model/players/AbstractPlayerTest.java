...
class AbstractPlayerTest {
  ...
  void testSetUp() {
    ArtificialPlayer aiPlayer = new ArtificialPlayer("bob",
        new ArtificialPlayerBoard(new Coordinate(10, 10), 10), 1);
    assertDoesNotThrow(() -> aiPlayer.setup(10, 10, this.specifications));
  }
  ...
  void testReportDamage() {
    assertThrows(IllegalArgumentException.class,
        () -> AbstractPlayerTest.MANUAL_PLAYER.reportDamage(List.of()));
