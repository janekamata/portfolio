...
public class Driver {
   ...
   * thrown. If there are two arguments, the run client helper is called which runs an auto game
   * controller, else if there are 0 arguments, a manual game controller is run.
   *
   * @param args the input arguments expected to be either 0 or 2 depending on the desired game
   *             mode
   */
